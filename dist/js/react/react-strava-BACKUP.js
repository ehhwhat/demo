...
class App extends React.Component {
    ...
    eventTypeFunction = (eventType) => {
        ...
        if(eventType === "Stats") {
            ...
            this.setState({dataBlockItem1: 75});
            this.setState({dataBlockItem1Title: "Weight"});
            this.setState({dataBlockItem1Measure: "kg"});
            this.setState({dataBlockItem2: 10});
            this.setState({dataBlockItem2Title: "Bodyfat"});
            this.setState({dataBlockItem2Measure: "%"});
            this.setState({dataBlockItem3: 55});
        ...
        return ([
                ...
                <main className={this.state.darkTheme ? 'theme-dark' : 'theme-light'} key="mainWrapper">
                    ...
                    <div className={"data-wrapper"}>
                        <DataBlock title={this.state.dataBlockItem1Title} position={"point1"} measure={this.state.dataBlockItem1Measure} dataFromParent={this.state.dataBlockItem1} loadingState={this.state.showLoading} />
                        <DataBlock title={this.state.dataBlockItem2Title} position={"point2"} measure={this.state.dataBlockItem2Measure} dataFromParent={this.state.dataBlockItem2} loadingState={this.state.showLoading} />
                        <DataBlock title={this.state.dataBlockItem3Title} position={"point3"} measure={this.state.dataBlockItem3Measure} dataFromParent={this.state.dataBlockItem3} loadingState={this.state.showLoading} />
