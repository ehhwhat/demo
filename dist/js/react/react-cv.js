console.log("%c react-cv.js CALLED", "padding:15px;margin:5px;color: #333;border-left:5px solid rebeccapurple;");
            ...
            <div>
                ...
                <div className="row my-5">
                    <div className="col-8 offset-2 col-sm-6 offset-sm-3">
                        <img src="../../img/app/triathlon/mk-winter-half-1.jpg" alt="..." className="img-fluid z-depth-2 rounded-circle" />
                    </div>
                </div>
                ...
                <div className="row my-5">
                    <div className="col-8 offset-2 col-sm-6 offset-sm-3">
                        <img src="../../img/app/triathlon/herts-10km-me1.jpg" alt="..." className="img-fluid z-depth-2 rounded-circle" />
                    </div>
                </div>
    ...
    render() {
        return (
            <div className="col-12">
                <h1 className="display-4">Benjamin Kenny</h1>
                <h2 className="display-5 text-muted">Front End Web Developer specialising in HTML, CSS (SASS), JS (Jquery)</h2>
...
class KeySkills extends React.Component {
    render() {
        ...
        return (
            <div className="col-12">
                <h3 className="mt-5">Skills and experience</h3>
...
class OtherSkills extends React.Component {
    render() {
        ...
        return (
            <div className="col-12">
                <h3 className="mt-5">Other experience</h3>
                <table className="table">
                    <thead className="">
                    <tr>
            ...
            <div className="col-12 ">
                <div className="card c012-card my-3 animated fadeIn">
                    <div className="card-header">
                        <h3 className="h3-responsive">{this.props.position}</h3>
                        <h5 className="h5-responsive">{this.props.company}</h5>
                    </div>
